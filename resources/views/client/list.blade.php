<x-app-layout>
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Danh sách khách hàng</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Khách hàng</span>
            </li>
        </ul>
    </div>
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12">
            <a href="{{route('client.add')}}" class="text-no-decoration">
                <button class="btn btn-success mb-3 text-white">Thêm mới khách hàng</button>
            </a>
                                        ...
                                        <th scope="col" class="text-primary">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label ms-2"
                                                    for="flexCheckDefault">Tên/Họ</label>
                                            </div>
                                        </th>
                                        <th scope="col">Số Điện Thoại</th>
                                        <th scope="col">Điểm/Kim cương</th>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-10">
                                                            <h4 class="fw-semibold fs-16 mb-0">{{ $client->firstname }}
                                                            </h4>
                                                            <span
                                                                class="text-gray-light">{{ $client->firstname . ' ' . $client->lastname }}</span>
                                                            @if (\Session::has('clientid') && \Session::get('clientid') === $client->id)
