<x-app-layout>
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Thêm mới khách hàng</h3>
    ...
    @section('javascript')
        ...
        <x-location-script :province="old('province', '')" :district="old('district', '')" :ward="old('ward', '')" :selector="'save-client'"></x-location-script>
    @endsection
</x-app-layout>
