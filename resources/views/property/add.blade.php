<x-app-layout>
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Thêm mới tài sản</h3>
            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    ...
                    <form method="POST" id="create-property" class="" novalidate
                        action="{{ route('property.store') }}" id="save-client" enctype="multipart/form-data">
                        @method('post')
                        @csrf
                        <div class="row">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="name"
                                            ...
                                            placeholder="BDS Hồ Tràm" value="{{ old('name') }}">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <img class="rounded-4 wh-78 ms-3 ms-lg-0"
                                                                        src="{{ asset('storage/' . old('avatar')) }}" />
                                                                    <p class="name">{{ old('avatar_name') }}</p>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="property-detail" name="content">{!! old('content') !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="avatar_name" value="{{ old('avatar_name') }}">
    ...
    @section('javascript')
        ...
        <x-dropzone-script :selector="'div.product-upload'" :url="route('ajax.draftupload')" :previewtemplate="false" :oldpath="old('avatar')" :oldname="old('avatar_name')"
            :name="'avatar'"></x-dropzone-script>
        <x-location-script :province="old('province', '')" :district="old('district', '')" :ward="old('ward', '')" :selector="'create-property'"></x-location-script>
    @endsection
</x-app-layout>
