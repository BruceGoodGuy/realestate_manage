                    ...
                    <li class="header-right-item">
                        <div class="dropdown admin-profile">
                            ...
                            <ul class="dropdown-menu border-0 bg-white w-100 admin-link">
                                <li>
                                    <x-responsive-nav-link :class="'dropdown-item d-flex align-items-center text-body'" :href="route('profile.edit')">
                                ...
                                <li>
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <x-responsive-nav-link :class="'dropdown-item d-flex align-items-center text-body'" :href="route('logout')"
                                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                                            <i data-feather="log-out"></i>
                                            <span class="ms-2">{{ __('Đăng Xuất') }}</span>
